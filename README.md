...
If you're having trouble accessing the video, click [here.](https://drive.google.com/file/d/1yWGX9juNkQzFHDRkIkE9eu7ICC3j_UIs/view?usp=sharing)
...
4. The application is already configured with the IBM server URL. If you want to run server on your local machine, follow the [Server Setup Documentation](https://github.com/PocketCareS/server/blob/master/Installation.md) and replace the **hostURL** variable in [Constants.swift](https://github.com/PocketCareS/PocketCareS-iOS/blob/master/PocketCare+/Extensions/Constants.swift#L19) file with your URL. 
